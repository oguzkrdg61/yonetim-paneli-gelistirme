 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link" style="text-align: center;">
    ...
    <span class="brand-text font-weight">Yönetim Paneli</span>
  </a>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item  menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./webtasarim" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Web Tasarım</p>
                </a>
              </li>
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./kategoriler" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kategoriler</p>
                </a>
              </li>
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./resimgaleri" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Resim Galeri</p>
                </a>
              </li>
