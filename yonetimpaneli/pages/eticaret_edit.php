...
$sql="UPDATE qp_ecommerce SET title=?, description=?, price=?, adddate=?, user_id=?, statu=?, image=? WHERE ID=?";
...
header("location: ./eticaret") ;
}else{ print '<div class="alert alert-danger">Resim güncellenemedi...</div>';}

}  }


$sql="UPDATE qp_ecommerce SET title=?, description=?, price=? adddate=?, user_id=?, statu=? WHERE ID=?";
