...
$sql="INSERT INTO qp_mobileapp(title, description, image, price,newprice, adddate, statu, user_id) VALUES (?,?,?,?,?,?,?)";
$args=[$title,$description,$image,$price,$newprice,$adddate,$statu, $user_id];
